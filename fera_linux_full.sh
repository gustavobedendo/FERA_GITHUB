...
DIST_DIR="./dist"
SOURCE_DIR="$DIST_DIR/fera_full"
TARGET_DIR="$DIST_DIR/FERA_FULL_LINUX"

mkdir -p "$DIST_DIR"

echo "[FERA build] Buildando FERA_FULL_LINUX..."
pyinstaller --noconfirm feralinux_full_noconsole.spec
